...
export const conversationMembers = sqliteTable(
	'conversation_members',
	{
		...
		currentlyMember: integer('currently_member', { mode: 'boolean' }).notNull().default(true),
		lastSeenMessageId: text('last_seen_message_id').references((): AnySQLiteColumn => messages.id)
	},
	(table) => {
		return {
